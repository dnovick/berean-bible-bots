...
|---|---|---|---|---|---|
| 1 | הוּרַד | Perfect | 3ms | יָרַד | שׁוּרֶק prefix (הוּ) — I-yod/vav Hophal marker; R1 י quiesces |
| 2 | יוּרַד | Imperfect | 3ms | יָרַד | שׁוּרֶק under imperfect prefix (יוּ) — I-yod/vav Hophal |
| 3 | הוּבָא | Perfect | 3ms | בּוֹא | הוּ prefix; hollow/I-vav root: בּוֹא (I-vav, biconsonantal) |
| 4 | הוּבְאוּ | Perfect | 3cp | בּוֹא | הוּ prefix + וּ plural ending; I-vav root |
| 5 | מוּבָאִים | Participle | mp | בּוֹא | מוּ prefix (שׁוּרֶק under מ) — I-vav/yod Hophal participle; ים plural |
| 6 | הוּקַם | Perfect | 3ms | קוּם | הוּ prefix; hollow biconsonantal root (medial וּ) |
| 7 | יוּמַת | Imperfect | 3ms | מוּת | יוּ prefix — biconsonantal Hophal imperfect; hollow root מוּת |
| 8 | הוּסַר | Perfect | 3ms | סוּר | הוּ prefix; hollow root סוּר; "it was removed" |
| 9 | הוּשַׁב | Perfect | 3ms | שׁוּב | הוּ prefix; hollow root שׁוּב; "it was returned" |
| 10 | יּוּשַׂם | Wayyiqtol | 3ms | שִׂים | יּוּ prefix (wayyiqtol) — dagesh in יּ + שׁוּרֶק; hollow/biconsonantal |
| 11 | וַיֻּגַּד | Wayyiqtol | 3ms | נָגַד | קִבּוּץ prefix (וַיֻּ) + dagesh forte in ג — I-nun: נ has assimilated |
| 12 | יֻּגַּד | Imperfect | 3ms | נָגַד | קִבּוּץ under prefix (יֻּ) + dagesh in R2 — I-nun pattern |
...
**1.** The I-yod/I-vav Hophal (e.g., הוּרַד, הוּבָא) and the Biconsonantal (hollow) Hophal (e.g., הוּקַם, הוּסַר) both use שׁוּרֶק as the prefix vowel. What phonological principle explains why *both* classes abandon the usual קִבּוּץ prefix of the strong Hophal? What happens to R1 in each class?

**2.** Compare וַיֻּגַּד (I-nun Hophal wayyiqtol, item 11) and יֻּכּוּ (I-nun Hophal, item 13). Both have dagesh forte in R2. What caused that dagesh? What happened to the נ of each root? Does anything else unusual happen to the form יֻּכּוּ beyond the I-nun assimilation?
