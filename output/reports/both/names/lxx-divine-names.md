...
Analysis of the major divine names in the LXX (canonical books only), drawn from STEPBible TALXX morphological data.
...
![LXX divine names distribution](lxx-divine-names-bar.png)

![LXX divine names heatmap](lxx-divine-names-heatmap.png)
...
_Source: STEPBible TALXX (CC BY 4.0, Tyndale House Cambridge)._
