...
| File | Description |
|---|---|
| [ch3-qamets-hatuf.md](ch3-qamets-hatuf.md) | Static reference copy with answer key |
| [ch3-qamets-hatuf.html](ch3-qamets-hatuf.html) | Interactive HTML with dropdown selection and per-row reveal |
| [ch3-qamets-hatuf.pdf](ch3-qamets-hatuf.pdf) | Fillable AcroForm PDF |
