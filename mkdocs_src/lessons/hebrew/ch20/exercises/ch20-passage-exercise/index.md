...
[Full screen](ch20-passage-exercise.html){.md-button}  [Markdown](ch20-passage-exercise.md){.md-button}  [Print (PDF)](ch20-passage-exercise.pdf){.md-button}
...
<div class="download-links" style="margin:1rem 0 .5rem;font-size:.85rem;">
  ...
  <a href="ch20-passage-exercise.md" style="margin-left:.5rem;">&#128196; Markdown</a>
  <span style="margin:0 .3rem;color:#aaa;">|</span>
  <a href="ch20-passage-exercise.pdf">&#128209; PDF</a>
</div>

<h1>Chapter 20 — Qal Infinitive Construct in Context</h1>
<p><em>For each highlighted IC form: (a) Root, (b) Root class, (c) Preposition, (d) Function. Click <strong>▶ Answer</strong> to reveal; click again to hide.</em></p>
...
<h2>Passage 1 — Genesis 2:16–17 (The Garden Command)</h2>
...
<p class="ref">Gen 39:18–19</p>
<p class="passage"><span class="h-inline">וַיְהִ֣י <strong>כְשָׁמְע֣וֹ</strong> אֶת-קוֹלִ֗י וַיַּעֲזֹ֤ב בִּגְדוֹ֙ אֶצְלִ֔י</span></p>
...
<tr><td>11</td><td class="hebrew">לָמ֑וּת</td><td><input class="parse-field" id="11-r"></td><td><input class="parse-field" id="11-cl"></td><td><input class="parse-field" id="11-p"></td><td><input class="parse-field" id="11-fn"></td><td><button class="toggle-btn" onclick="tog('a11')">▶ Answer</button></td></tr>
<tr class="answer-row" id="a11"><td colspan="7">מות · Biconsonantal · לְ · Epexegetical — "to die"; full shureq (וּ); לָ prefix before biconsonantal IC</td></tr>
<tr><td>12</td><td class="hebrew">לִנְטֹ֙עַ֙</td><td><input class="parse-field" id="12-r"></td><td><input class="parse-field" id="12-cl"></td><td><input class="parse-field" id="12-p"></td><td><input class="parse-field" id="12-fn"></td><td><button class="toggle-btn" onclick="tog('a12')">▶ Answer</button></td></tr>
...
<ol>
<li>How does לֵאמֹר (Gen 2:16) function differently from other לְ + IC forms in these passages? What makes it a "quotative formula" rather than a purpose clause?</li>
<li>In Gen 39:18–19, both כְשָׁמְעוֹ (with suffix) and כִשְׁמֹעַ (bare) express temporal meaning. What structural difference do you observe, and does the meaning change?</li>
<li>Compare לְמָכְרֵנִי and לְמִחְיָה in Gen 45:4–5. Both are לְ + IC purpose clauses, yet they express opposing purposes. How does recognizing both as IC forms sharpen your understanding of Joseph's theological argument?</li>
</ol>
