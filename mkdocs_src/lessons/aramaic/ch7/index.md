...
- **Most prepositions are shared with Hebrew**, though vowel pointing and usage patterns differ in detail.
- **Biblical Aramaic has its own connector word, דִּי**, which functions as a relative pronoun, a genitive particle, and the first element of many compound prepositions. It has no single Hebrew equivalent.
- **Prefixed prepositions** (בְּ-, לְ-, כְּ-) work similarly to Hebrew but interact differently with the determined state ending ָא.
- **Stand-alone prepositions** such as מִן and עַד appear frequently in Daniel and Ezra.
- The particle **אַף** ("also, even") and the logical connectors **הֵן** ("if/whether/behold") and **לָהֵן** ("therefore/but/except") are characteristic Aramaic vocabulary items that fall naturally into this chapter.
...
- Coordinates nouns: **מַלְכָּא וְשָׁלִיטָא** — "the king and the ruler"
- Coordinates clauses: **שְׁמַע מַלְכָּא וּנְפַל עַל אַנְפּוֹהִי** — "the king heard and fell on his face"
- Can introduce contrast: "but" (context-dependent)

---

## 3. The Conjunction דִּי
...
- Verb follows → relative pronoun ("that/which/who")
- Noun follows → genitive ("of")

---

## 4. Independent Prepositions
...
### עַל — Upon, Over, Concerning

עַל functions much like its Hebrew counterpart:

- Spatial: **נְפַל עַל אַנְפּוֹהִי** — "he fell upon his face" (Dan 2:46)
- Concerning: **שִׂים עַל בָּבֶל** — "set over Babylon" (Dan 2:48)
- Against: **קָם עַל מַלְכָּא** — "rose up against the king"

### עַד — Until, Up To

- Temporal: **עַד עָלְמָא** — "until/unto eternity, forever" (Dan 2:44)
- Spatial: **עַד שְׁמַיָּא** — "up to the heavens" (Dan 4:8)
...
- **קֳדָם מַלְכָּא** — "before the king" (Dan 2:27)
- **קֳדָם אֱלָהָא** — "before God"

### אַחֲרֵי — After, Behind (Vocab Word)
...
- **אַחֲרֵי דְנָה** — "after this" (Dan 2:29)
- As a conjunction with דִּי: **אַחֲרֵי דִּי** — "after that" (see Section 7)

> **Compare:** **בַּתַר** is a synonymous preposition also meaning "after, behind" that appears in Aramaic. Both are used in Daniel.

### לְקֳבֵל — Over Against, Before, Because Of
...
- **לְקֳבֵל דְּנָה** — "therefore, on account of this" (Dan 2:12)
- **כָּל-קֳבֵל דִּי** — "because" (Dan 2:40)

---

## 5. Prefixed Prepositions
...
### Prefixing to Determined Nouns (the ָא Ending)
...
### Vowel Adjustment Before Composite Shewa
...
- **כְּחֶזְוָא** — "like a vision" (Dan 2:31)
- **כְּסַף וּכְדַהַב** — "silver and gold" (combined with waw)
- **כְּמֵימַר מַלְכָּא** — "according to the word of the king"

---

## 6. מִן — The Versatile Preposition
...
### Comparative Use ("More Than")

The comparative "more than" use of מִן is important and frequent:

- **יַתִּיר מִן כֹּל חַכִּימֵי בָבֶל** — "exceedingly more than all the wise men of Babylon" (cf. Dan 1:20)
- **רַב מִן כֹּל** — "greater than all"

### Temporal and Logical Extension

- **מִן-קַדְמַת דְּנָא** — "from ancient times, formerly"
- **מִן דִּי** — "from the time that / since / because" (compound, see Section 7)

---

## 7. Compound Prepositions with דִּי
