...
**How to distinguish:**
- A sheva under the **first letter of a word** is always **vocal**.
- A sheva under a consonant with **Dagesh Forte** is always **vocal**.
- Two shevas in succession: the **first is silent**, the **second is vocal**.
- A sheva after a long vowel is usually **vocal**.
- A sheva after a short vowel in a closed syllable is usually **silent**.
