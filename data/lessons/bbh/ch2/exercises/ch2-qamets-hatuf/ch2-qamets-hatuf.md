...
**Topic:** Distinguishing Long A (Qamets) from Short O (Qamets Hatuf)

---

**Background:** Both Qamets (long A) and Qamets Hatuf (short O) use the identical T-bar symbol (ָ). Context is the only guide:

- **Qamets (long A):** appears in open syllables, or in closed *accented* syllables, or when a Metheg is present.
- **Qamets Hatuf (short O):** appears in *closed*, *unaccented* syllables with *no* Metheg.
