...
[Full screen](ch18-passage-exercise.html){.md-button}  [Markdown](ch18-passage-exercise.md){.md-button}  [Print (PDF)](ch18-passage-exercise.pdf){.md-button}
...
.passage{background:#f0f4e8;border-left:4px solid #2c5f2e;padding:.7em 1em;margin:.7em 0;border-radius:3px}
.hebrew{font-size:1.25em;direction:rtl;unicode-bidi:embed;line-height:1.8}
...
.ref{font-size:.85em;color:#555;font-style:italic}
@media print{
...
<div class="download-links" style="margin:1rem 0 .5rem;font-size:.85rem;">
  ...
  <a href="ch18-passage-exercise.md" style="margin-left:.5rem;">&#128196; Markdown</a>
  <span style="margin:0 .3rem;color:#aaa;">|</span>
  <a href="ch18-passage-exercise.pdf">&#128209; PDF</a>
</div>

<h1>Chapter 18 — Qal Imperative Passage Exercise</h1>
<p><em>For each highlighted form: (a) Form Type, (b) Person, (c) Number, (d) Gender, (e) Root, (f) Usage Note. Click <strong>▶ Answer</strong> to reveal.</em></p>
...
<div class="note-box"><strong>Remember:</strong> Positive commands use the <strong>Imperative</strong> (no prefix). Negative commands use <strong>אַל + Jussive</strong> or <strong>לֹא + Imperfect</strong> — never the Imperative. Watch for <strong>וְ + Imperative</strong> (imperative chain) vs. <strong>Weqatal</strong> — both start with וְ but serve different functions.</div>

<h2>Passage A — Genesis 12:1–3 (The Call of Abraham)</h2>
<div class="passage">
<div class="hebrew">
<strong>לֶךְ</strong>־לְךָ֛ מֵאַרְצְךָ֥ וּמִמּֽוֹלַדְתְּךָ֖<br>
<strong>וַ/עֲזֹב</strong>־אֶת־בֵּ֣ית אָבִ֑יךָ<br>
אֶל־הָאָ֖רֶץ אֲשֶׁ֥ר אַרְאֶֽךָּ׃<br>
<strong>וֶ/הְיֵ֖ה</strong> בְּרָכָֽה׃
</div>
...
<tr><td>2</td><td class="hebrew">עֲזֹב</td><td><input class="parse-field" id="2-t"></td><td><input class="parse-field" id="2-p"></td><td><input class="parse-field" id="2-n"></td><td><input class="parse-field" id="2-g"></td><td><input class="parse-field" id="2-r"></td><td><input class="parse-field" id="2-u"></td><td><button class="toggle-btn" onclick="tog('a2')">▶ Answer</button></td></tr>
<tr class="answer-row" id="a2"><td colspan="9">Imperative · 2nd · s · m · עזב · Direct Command — Strong A-class; "Leave!" — second imperative in the triple command sequence</td></tr>
...
<div class="passage">
<div class="hebrew">
<strong>קַח</strong>־נָ֠א אֶת־בִּנְךָ֨ אֶת־יְחִֽידְךָ֤<br>
אֲשֶׁר־אָהַ֙בְתָּ֙ אֶת־יִצְחָ֔ק<br>
<strong>וְ/לֶךְ</strong>־לְךָ֔ אֶל־אֶ֖רֶץ הַמֹּרִיָּ֑ה<br>
<strong>וְ/הַעֲלֵ֤הוּ</strong> שָׁם֙ לְעֹלָ֔ה
</div>
...
<tr><td>5</td><td class="hebrew">וְלֶךְ</td><td><input class="parse-field" id="5-t"></td><td><input class="parse-field" id="5-p"></td><td><input class="parse-field" id="5-n"></td><td><input class="parse-field" id="5-g"></td><td><input class="parse-field" id="5-r"></td><td><input class="parse-field" id="5-u"></td><td><button class="toggle-btn" onclick="tog('b5')">▶ Answer</button></td></tr>
<tr class="answer-row" id="b5"><td colspan="9">Imperative · 2nd · s · m · הלך · Command Chain — וְ + Imperative (not Weqatal); continues series of divine commands</td></tr>
...
<div class="passage">
<div class="hebrew">
<strong>שְׁמַ֖ע</strong> יִשְׂרָאֵ֑ל יְהוָ֥ה אֱלֹהֵ֖ינוּ יְהוָ֥ה אֶחָֽד׃<br>
<strong>וְ/אָ֣הַבְתָּ֔</strong> אֵ֖ת יְהוָ֣ה אֱלֹהֶ֑יךָ<br>
<strong>וְ/שִׁנַּנְתָּ֣ם</strong> לְבָנֶ֔יךָ<br>
<strong>וְ/דִבַּרְתָּ֣</strong> בָּ֔ם בְּשִׁבְתְּךָ֥ בְבֵיתֶ֖ךָ
</div>
...
<tr><td>8</td><td class="hebrew">וְאָהַבְתָּ</td><td><input class="parse-field" id="8-t"></td><td><input class="parse-field" id="8-p"></td><td><input class="parse-field" id="8-n"></td><td><input class="parse-field" id="8-g"></td><td><input class="parse-field" id="8-r"></td><td><input class="parse-field" id="8-u"></td><td><button class="toggle-btn" onclick="tog('c8')">▶ Answer</button></td></tr>
<tr class="answer-row" id="c8"><td colspan="9">Weqatal · 2nd · s · m · אהב · Command Chain — Weqatal (not Imperative) continues the command chain after שְׁמַע; "and you shall love"</td></tr>

<tr><td>9</td><td class="hebrew">וְשִׁנַּנְתָּם</td><td><input class="parse-field" id="9-t"></td><td><input class="parse-field" id="9-p"></td><td><input class="parse-field" id="9-n"></td><td><input class="parse-field" id="9-g"></td><td><input class="parse-field" id="9-r"></td><td><input class="parse-field" id="9-u"></td><td><button class="toggle-btn" onclick="tog('c9')">▶ Answer</button></td></tr>
<tr class="answer-row" id="c9"><td colspan="9">Weqatal · 2nd · s · m · שנן · Command Chain — Piel Weqatal; "and you shall teach them diligently"; continues Shema command chain</td></tr>
...
<div class="passage">
<div class="hebrew">
<strong>פְּר֥וּ</strong> וּ/<strong>רְב֖וּ</strong> וּ/<strong>מִלְא֣וּ</strong> אֶת־הָאָ֑רֶץ [Gen 1:28]
</div>
<br>
<div class="hebrew">
אַל־<strong>תִּקְרַ֣ב</strong> הֲלֹ֑ם
<strong>שַׁל</strong>־נְעָלֶ֙יךָ֙ מֵעַ֣ל רַגְלֶ֔יךָ [Exo 3:5]
</div>
</div>
...
<tr><td>12</td><td class="hebrew">רְבוּ</td><td><input class="parse-field" id="12-t"></td><td><input class="parse-field" id="12-p"></td><td><input class="parse-field" id="12-n"></td><td><input class="parse-field" id="12-g"></td><td><input class="parse-field" id="12-r"></td><td><input class="parse-field" id="12-u"></td><td><button class="toggle-btn" onclick="tog('d12')">▶ Answer</button></td></tr>
<tr class="answer-row" id="d12"><td colspan="9">Imperative · 2nd · p · m · רבה · Direct Command — III-ה 2mp; paired with פְּרוּ; "Multiply!"</td></tr>

<tr><td>13</td><td class="hebrew">מִלְאוּ</td><td><input class="parse-field" id="13-t"></td><td><input class="parse-field" id="13-p"></td><td><input class="parse-field" id="13-n"></td><td><input class="parse-field" id="13-g"></td><td><input class="parse-field" id="13-r"></td><td><input class="parse-field" id="13-u"></td><td><button class="toggle-btn" onclick="tog('d13')">▶ Answer</button></td></tr>
<tr class="answer-row" id="d13"><td colspan="9">Imperative · 2nd · p · m · מלא · Direct Command — III-א 2mp; aleph quiesces; "Fill (the earth)!"</td></tr>

<tr><td>14</td><td class="hebrew">אַל־תִּקְרַב</td><td><input class="parse-field" id="14-t"></td><td><input class="parse-field" id="14-p"></td><td><input class="parse-field" id="14-n"></td><td><input class="parse-field" id="14-g"></td><td><input class="parse-field" id="14-r"></td><td><input class="parse-field" id="14-u"></td><td><button class="toggle-btn" onclick="tog('d14')">▶ Answer</button></td></tr>
<tr class="answer-row" id="d14"><td colspan="9">Jussive (with אַל) · 2nd · s · m · קרב · Prohibition — אַל + Jussive 2ms; NOT Imperative — negative commands always use Jussive; "Do not come near here!"</td></tr>
...
<div class="passage">
<div class="hebrew">
<strong>עֲל֥וּ</strong> זֶ֖ה בַּנֶּ֑גֶב
</div>
...
<ol>
<li>In Passage A (Gen 12:1–2), Genesis uses a sequence of three imperatives (לֶךְ … עֲזֹב … וֶהְיֵה) rather than weqatal forms. In Passage C (Deu 6:4–7), a single imperative (שְׁמַע) launches a chain of Weqatal forms. What does the choice between <em>imperative chain</em> (וְ + Imperative) and <em>Weqatal chain</em> communicate about the grammatical weight or force of the commands in each passage?</li>

<li>In Passage D (Exo 3:5), the prohibition "Do not come near" uses אַל + Jussive (אַל־תִּקְרַב), while the positive command "Remove your sandals" uses the Imperative (שַׁל). Hebrew consistently distinguishes positive from negative commands at the grammatical level. Why do you think the language reserves the Imperative exclusively for positive commands? What would it mean theologically or rhetorically if negative commands could also use the Imperative form?</li>

<li>In Passage D (Gen 1:28), the creation mandate is expressed as a triplet of imperatives addressed to humanity: פְּרוּ וּרְבוּ וּמִלְאוּ. These are 2mp forms (addressed to the first humans together). How does the choice of the plural imperative vs. a singular imperative shape the nature of the command? What other occasions in Genesis do you observe God shifting between singular and plural direct address, and what might that signal?</li>
</ol>
