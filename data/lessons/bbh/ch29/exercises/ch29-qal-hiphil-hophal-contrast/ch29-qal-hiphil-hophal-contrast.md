...
This drill presents five weak-root triplets. Each group shows the **same root in three stems: Qal, Hiphil, and Hophal** across three conjugations: **Perfect 3ms**, **Imperfect 3ms**, and **Participle ms** (9 forms per root, 45 total).

For each form:
1. **Identify the stem** (Qal / Hiphil / Hophal).
2. **Parse** the conjugation and PGN.
3. **Translate** each form, noting how the meaning shifts across stems.
...
| # | Hebrew Form | Stem | Conjugation | PGN | Translation |
|---|---|---|---|---|---|
| 1 | בָּא | | | | |
| 2 | הֵבִיא | | | | |
| 3 | הוּבָא | | | | |
...
| # | Hebrew Form | Stem | Conjugation | PGN | Translation |
|---|---|---|---|---|---|
| 7 | בָּא | **Qal** | Participle | ms | one coming / coming |
| 8 | מֵבִיא | **Hiphil** | Participle | ms | one who brings / bringing |
| 9 | מוּבָא | **Hophal** | Participle | ms | one being brought |

*Note: items 1 and 7 (בָּא) are identical surface forms — context (article, verbal agreement) distinguishes Participle from Perfect.*
...
| # | Hebrew Form | Stem | Conjugation | PGN | Translation |
|---|---|---|---|---|---|
| 16 | יֹרֵד | **Qal** | Participle | ms | one going down / descending |
...
| 20 | הֵשִׁיב | **Hiphil** | Perfect | 3ms | he returned (it) / brought back |
| 21 | הוּשַׁב | **Hophal** | Perfect | 3ms | he was brought back |
...
| 23 | יָשִׁיב | **Hiphil** | Imperfect | 3ms | he will bring back / restore |
| 24 | יוּשַׁב | **Hophal** | Imperfect | 3ms | he will be brought back |

**Participle ms**

| # | Hebrew Form | Stem | Conjugation | PGN | Translation |
|---|---|---|---|---|---|
| 25 | שָׁב | **Qal** | Participle | ms | one returning / returning |
| 26 | מֵשִׁיב | **Hiphil** | Participle | ms | one who brings back / restoring |
| 27 | מוּשָׁב | **Hophal** | Participle | ms | one being brought back |

*Note: items 19 and 25 (שָׁב) are identical surface forms — context distinguishes Participle from Perfect.*
...
| # | Hebrew Form | Stem | Conjugation | PGN | Translation |
|---|---|---|---|---|---|
| 34 | קָם | **Qal** | Participle | ms | one arising / rising |
| 35 | מֵקִים | **Hiphil** | Participle | ms | one who raises up / establishing |
| 36 | מוּקָם | **Hophal** | Participle | ms | one being raised up |

*Note: items 28 and 34 (קָם) are identical surface forms — context distinguishes Participle from Perfect.*
