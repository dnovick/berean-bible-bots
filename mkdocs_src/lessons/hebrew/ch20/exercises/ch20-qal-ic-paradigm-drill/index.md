# Qal Ic Paradigm Drill

*Chapter 20 — Qal Infinitive Construct*

[Full screen](ch20-qal-ic-paradigm-drill.html){.md-button}  [Markdown](ch20-qal-ic-paradigm-drill.md){.md-button}  [Print (PDF)](ch20-qal-ic-paradigm-drill.pdf){.md-button}
...
<div class="download-links" style="margin:1rem 0 .5rem;font-size:.85rem;">
  ...
  <a href="ch20-qal-ic-paradigm-drill.md" style="margin-left:.5rem;">&#128196; Markdown</a>
  <span style="margin:0 .3rem;color:#aaa;">|</span>
  <a href="ch20-qal-ic-paradigm-drill.pdf">&#128209; PDF</a>
</div>


<h1>Ch20 Qal Infinitive Construct Paradigm Drill</h1>
<p class="subtitle">BBH Chapter 20 · 6 root classes · Bare IC and + לְ forms</p>

<div class="instructions">
  <strong>Instructions:</strong> Give the bare Infinitive Construct and the form with לְ for each root class.
  Fill both blanks from memory.
</div>
...
<table>
  <tr><th>#</th><th>Root class</th><th>Root</th><th>Bare IC</th><th>+ לְ</th><th></th></tr>

  <tr>
    <td class="num">1</td>
    <td class="pgn">Strong A</td>
    <td class="root">שמר</td>
    <td><input class="parse-field" id="f-1a" placeholder="כתוב..."></td>
    <td><input class="parse-field" id="f-1b" placeholder="כתוב..."></td>
  ...
  <tr class="ans-row" id="ans-1">
    ...
    <td class="pgn">Strong A</td>
    <td class="root">שמר</td>
    <td class="heb-ans">שְׁמֹר</td>
    <td class="heb-ans">לִשְׁמֹר</td>
    <td></td>
  </tr>
  ...
  <tr>
    ...
    <td><input class="parse-field" id="f-2a" placeholder="כתוב..."></td>
    <td><input class="parse-field" id="f-2b" placeholder="כתוב..."></td>
  ...
  <tr class="ans-row" id="ans-2">
    ...
    <td class="pgn">III-ה</td>
    <td class="root">ראה</td>
    <td class="heb-ans">רְאוֹת</td>
    <td class="heb-ans">לִרְאוֹת</td>
    <td></td>
  </tr>
  ...
  <tr>
    ...
    <td class="root">שוב</td>
    <td><input class="parse-field" id="f-3a" placeholder="כתוב..."></td>
    <td><input class="parse-field" id="f-3b" placeholder="כתוב..."></td>
  ...
  <tr class="ans-row" id="ans-3">
    ...
    <td class="pgn">Biconsonantal</td>
    <td class="root">שוב</td>
    <td class="heb-ans">שׁוּב</td>
    <td class="heb-ans">לָשׁוּב</td>
    <td></td>
  </tr>
  ...
  <tr>
    <td class="num">4</td>
    <td class="pgn">I-י</td>
    <td class="root">ישב</td>
    <td><input class="parse-field" id="f-4a" placeholder="כתוב..."></td>
    <td><input class="parse-field" id="f-4b" placeholder="כתוב..."></td>
  ...
  <tr class="ans-row" id="ans-4">
    ...
    <td class="pgn">I-י</td>
    <td class="root">ישב</td>
    <td class="heb-ans">שֶׁבֶת</td>
    <td class="heb-ans">לָשֶׁבֶת</td>
    <td></td>
  </tr>
  ...
  <tr>
    ...
    <td><input class="parse-field" id="f-5a" placeholder="כתוב..."></td>
    <td><input class="parse-field" id="f-5b" placeholder="כתוב..."></td>
  ...
  <tr class="ans-row" id="ans-5">
    ...
    <td class="pgn">I-נ</td>
    <td class="root">נתן</td>
    <td class="heb-ans">תֵּת</td>
    <td class="heb-ans">לָתֵת</td>
    <td></td>
  </tr>
  ...
  <tr>
    ...
    <td class="root">אמר</td>
    <td><input class="parse-field" id="f-6a" placeholder="כתוב..."></td>
    <td><input class="parse-field" id="f-6b" placeholder="כתוב..."></td>
  ...
  <tr class="ans-row" id="ans-6">
    ...
    <td class="pgn">I-aleph</td>
    <td class="root">אמר</td>
    <td class="heb-ans">אֱמֹר</td>
    <td class="heb-ans">לֵאמֹר</td>
    <td></td>
  </tr>
