...
For each of the 24 forms below, identify the **stem** (Qal, Piel, or Pual), then provide a full parse (conjugation, PGN) and translation.

Forms are drawn from a single root family (דבר / שׁלח / כבד / ספר) with all three stems represented 8 times each, interleaved across multiple conjugations.
...
| 23 | מְדֻבָּר | Pual | Participle | ms | דבר | being spoken / what is spoken |
