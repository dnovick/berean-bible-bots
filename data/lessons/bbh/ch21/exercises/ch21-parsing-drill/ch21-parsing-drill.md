# Ch21 Parsing Drill — Qal Infinitive Absolute

*For each form: (a) Identify as IA, IC, Imperative, Imperfect, or Perfect — and briefly explain how you know; (b) Root; (c) Root class; (d) Function (if IA: Emphatic / Imperatival / Manner / Progressive / Serial).*

---

## Part A — Emphatic Pairs (IA + Finite Verb)

*Both members of each pair are given. Identify the IA and the finite verb, name the root, and state the function.*

| # | Form Pair | Which is IA? | Root | Root Class | Function | Gloss |
|---|---|---|---|---|---|---|
| 1 | מ֥וֹת — תָּמוּת | | | | | |
| 2 | אָכֹ֥ל — תֹּאכֵֽל | | | | | |
...
## Part B — Standalone IA Forms (Imperatival / Manner / Progressive)

*No paired finite verb given. Identify each as IA, give the root and class, and state the function.*

| # | Form | IA or other? | Root | Root Class | Function |
|---|---|---|---|---|---|
| 9 | זָכ֕וֹר | | | | |
| 10 | שָׁמ֗וֹר | | | | |
| 11 | הָל֣וֹךְ | | | | |
...
## Part C — Discrimination: IA, IC, Imperative, Imperfect, or Perfect

*Identify each form. Use vowel patterns and context clues where given.*

| # | Form | Context given? | Identification | Root | Notes |
|---|---|---|---|---|---|
...
| 21 | זָכ֕וֹר | preceded by imperative context | | | |
...
| 8 | אָבֹ֖ד — תֹּאבֵדוּן | אָבֹ֖ד | אבד | Strong A | Emphatic | "you shall utterly perish"; Deu threat formula |
