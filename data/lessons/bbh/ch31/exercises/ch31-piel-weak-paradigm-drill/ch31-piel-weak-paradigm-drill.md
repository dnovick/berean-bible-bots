...
**Key rule (BBH Ch31 priority class):** R2 = א refuses Dagesh Forte. Three simultaneous changes: (1) No Dagesh in R2; (2) Compensatory lengthening — Perfect R1: Hireq → Tsere; Imperfect/Imperative/Ptc R1: Pathach → Qamets; (3) Alef takes Pathach (a-class) at R2, Hateph-Pathach before vowel suffixes. Attested: בֵּאַר (Deut 1:5).
...
| # | PGN | Form | Note |
|---|---|---|---|
| 28 | Perf 3ms | בֵּאַר | Tsere under ב (R1, compensatory) + no dagesh in א + Pathach under א (a-class). Attested: Deut 1:5 |
| 29 | Perf 2ms | בֵּאַרְתָּ | Tsere under ב + Pathach under א (closed syllable) + תָּ suffix |
| 30 | Perf 1cs | בֵּאַרְתִּי | Tsere under ב + Pathach + תִּי suffix |
| 31 | Perf 3cp | בֵּאֲרוּ | Tsere under ב + Hateph-Pathach under א (aleph refuses simple Shewa) + וּ |
| 32 | Impf 3ms | יְבָאַר | יְ prefix + Qamets under ב (R1, compensatory) + no dagesh in א + Pathach under א |
| 33 | Impf 3mp | יְבָאֲרוּ | יְ + Qamets under ב + Hateph-Pathach under א + וּ |
| 34 | Imp 2ms | בָּאַר | Qamets under ב (same compensatory pattern as Impf R1) + Pathach under א; no prefix or suffix |
| 35 | Ptc. ms | מְבָאַר | מְ prefix + Qamets under ב + Pathach under א |
