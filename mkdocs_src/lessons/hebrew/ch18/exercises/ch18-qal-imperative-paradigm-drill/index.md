# Qal Imperative Paradigm Drill

*Chapter 18 — Qal Imperative*

[Full screen](ch18-qal-imperative-paradigm-drill.html){.md-button}  [Markdown](ch18-qal-imperative-paradigm-drill.md){.md-button}  [Print (PDF)](ch18-qal-imperative-paradigm-drill.pdf){.md-button}
...
<div class="instructions">
  <strong>Instructions:</strong> Write the Qal Imperative form for each PGN.
  Root: שמר (A-class). Note: the Imperative has only 2nd-person forms.
</div>
...
<table>
  ...
  <tr class="ans-row" id="ans-4">
    <td class="ans-lbl">✓</td>
    <td class="pgn">2fp</td>
    <td class="heb-ans">שְׁמֹרְנָה</td>
    <td></td>
  </tr>
