...
For each form: identify the **stem** (Niphal / Hiphil / Hophal / Qal), **conjugation**, **PGN**, **weak class** (Biconsonantal or Geminate), and **root**.

## Mixed Drill — 24 Items

| # | Form | Stem | Conj | PGN | Class | Root |
|---|---|---|---|---|---|---|
| 1 | נָכוֹן (Gen 41:32) | | | | | |
| 2 | הֵקִים (Gen 6:18) | | | | | |
| 3 | נָסַב (1 Kgs 7:24) | | | | | |
