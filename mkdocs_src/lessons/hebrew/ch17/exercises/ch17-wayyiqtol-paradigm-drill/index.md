# Wayyiqtol Paradigm Drill

*Chapter 17 — Waw-Consecutive*

[Full screen](ch17-wayyiqtol-paradigm-drill.html){.md-button}  [Markdown](ch17-wayyiqtol-paradigm-drill.md){.md-button}  [Print (PDF)](ch17-wayyiqtol-paradigm-drill.pdf){.md-button}
...
<div class="download-links" style="margin:1rem 0 .5rem;font-size:.85rem;">
  ...
  <a href="ch17-wayyiqtol-paradigm-drill.md" style="margin-left:.5rem;">&#128196; Markdown</a>
  <span style="margin:0 .3rem;color:#aaa;">|</span>
  <a href="ch17-wayyiqtol-paradigm-drill.pdf">&#128209; PDF</a>
</div>


<h1>Ch17 Wayyiqtol Paradigm Drill</h1>
<p class="subtitle">BBH Chapter 17 · 10 forms · Root: קטל (Waw-Consecutive Imperfect)</p>

<div class="instructions">
  <strong>Instructions:</strong> Write the Wayyiqtol (Waw-Consecutive Imperfect) form for each PGN.
  Root: קטל. Note: the 1cs prefix waw takes qamets (וָ) because aleph cannot take dagesh.
</div>
...
<table>
  <tr><th>#</th><th>PGN</th><th>Form</th><th></th></tr>
  ...
  <tr class="ans-row" id="ans-1">
    <td class="ans-lbl">✓</td>
    <td class="pgn">3ms</td>
    <td class="heb-ans">וַיִּקְטֹל</td>
    <td></td>
  </tr>
  ...
  <tr class="ans-row" id="ans-2">
    <td class="ans-lbl">✓</td>
    <td class="pgn">3fs</td>
    <td class="heb-ans">וַתִּקְטֹל</td>
    <td></td>
  </tr>
  ...
  <tr class="ans-row" id="ans-4">
    <td class="ans-lbl">✓</td>
    <td class="pgn">2fs</td>
    <td class="heb-ans">וַתִּקְטְלִי</td>
    <td></td>
  </tr>
  ...
  <tr class="ans-row" id="ans-6">
    <td class="ans-lbl">✓</td>
    <td class="pgn">3mp</td>
    <td class="heb-ans">וַיִּקְטְלוּ</td>
    <td></td>
  </tr>
  ...
  <tr class="ans-row" id="ans-7">
    <td class="ans-lbl">✓</td>
    <td class="pgn">3fp</td>
    <td class="heb-ans">וַתִּקְטֹלְנָה</td>
    <td></td>
  </tr>
  ...
  <tr class="ans-row" id="ans-8">
    <td class="ans-lbl">✓</td>
    <td class="pgn">2mp</td>
    <td class="heb-ans">וַתִּקְטְלוּ</td>
    <td></td>
  </tr>
  ...
  <tr>
    <td class="num">10</td>
    <td class="pgn">1cp</td>
    <td><input class="parse-field" id="f-10" placeholder="כתוב..."></td>
    <td><button class="rbtn" onclick="tog(10)">▶ Answer</button></td>
  </tr>
  <tr class="ans-row" id="ans-10">
    <td class="ans-lbl">✓</td>
    <td class="pgn">1cp</td>
    <td class="heb-ans">וַנִּקְטֹל</td>
    <td></td>
  </tr>
