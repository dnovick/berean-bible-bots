...
3. An alternative construction using the particle **דִּי** (*dî*, "of") can replace the construct relationship analytically — both patterns appear in Biblical Aramaic.
...
3. The **definiteness of the entire chain** is determined by the **last noun**:
   - If the final noun is **absolute** (indefinite), the whole chain is indefinite.
   - If the final noun is **determined** (definite), the whole chain is definite.
