# Ch22 Parsing Drill — Qal Participle (Active and Passive)

*For each form: (a) Active or Passive participle (or other form), (b) Root, (c) Root class, (d) Gender and Number (if participle), (e) Function (Attributive / Predicate / Substantive / Progressive / Occupational / Resultant state).*

---

## Part A — Active Participle, Strong Roots

*All forms are Qal active participles.*

| # | Form | Act. or Pass.? | Root | Root Class | Gender/Number | Function |
|---|---|---|---|---|---|---|
| 1 | שֹׁמֵ֖ר | | | | | |
| 2 | שֹׁמֶ֫רֶת | | | | | |
| 3 | שֹׁמְרִ֖ים | | | | | |
...
*Identify whether each form is a Qal active ptc., passive ptc., Perfect, Imperfect, or other form.*
