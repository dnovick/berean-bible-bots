# Divine Names & Christological Titles — New Testament Greek

*Build script: [scripts/both/names/build_divine_names.py](../../../../scripts/both/names/build_divine_names.py)*

← [Back to Divine Names overview](divine-names-report.md)

---

Analysis of divine names and Christological titles in the Greek NT, drawn from STEPBible TAGNT morphological data.
...
![NT divine names distribution](nt-divine-names-bar.png)

![NT divine names heatmap](nt-divine-names-heatmap.png)
...
_Source: STEPBible TAGNT (CC BY 4.0, Tyndale House Cambridge)._
