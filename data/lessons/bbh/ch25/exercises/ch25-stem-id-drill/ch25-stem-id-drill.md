# Chapter 25 — Stem-ID Drill (Weak Roots)

*Identifying Qal and Niphal forms of III-ה, I-נ, and hollow roots*

---

## Instructions

For each Hebrew form below, identify:

1. **Stem** — Qal or Niphal
2. **Conjugation** — Perfect, Imperfect, Wayyiqtol, Imperative, Inf. Absolute, Participle
3. **PGN** — person/gender/number (write **—** for non-finite forms)
4. **Root** — the three-letter lexical root
...
| Conjugation | Qal (גלה) | Niphal (גלה) | Distinguishing feature |
|---|---|---|---|
| Perfect 3ms | גָּלָה | נִגְלָה | נִ prefix |
| Imperfect 3ms | יִגְלֶה | יִגָּלֶה | dagesh forte in גּ (Niphal) |
| Wayyiqtol 3ms | וַיִּגֶּל | וַיִּגָּל | dagesh forte in גּ (Niphal) |
| Imperative 2ms | גְּלֵה | הִגָּלֵה | הִ prefix + dagesh (Niphal) |
| Inf. Absolute | גָּלֹה | הִגָּלֹה | הִ prefix + dagesh (Niphal) |
| Participle ms | גֹּלֶה | נִגְלֶה | נִ prefix (Niphal) |
...
|---|---|---|---|
| Perfect 3ms | שָׁב | נָשׁוּב | נָ prefix (Niphal) |
| Imperfect 3ms | יָשׁוּב | יִשָּׁב | dagesh forte in שּׁ (Niphal) |
