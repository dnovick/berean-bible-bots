...
|---|---|
| [Noun Identification Drill](exercises/ch4-noun-identification/ch4-noun-identification.md) | 20-item drill — identify gender, number, state, and root/lexical form for absolute-state noun forms drawn from Chapter 4 vocabulary |
