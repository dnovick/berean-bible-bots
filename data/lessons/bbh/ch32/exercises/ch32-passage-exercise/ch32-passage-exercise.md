...
5. **Stem / Function** (if Pual: Passive — state what the Piel means and how Pual passivizes it; if not: name the stem)
...
1. In Passage A, verbs 1 (תְּבָרֵךְ) and 2 (מְבֹרָךְ) come from the same root ברך but are in different stems. What is the active/passive relationship between them, and how does the Pual vowel pattern (Qamets under R1, since ר rejects dagesh) differ from what you would expect in a strong Pual form?
