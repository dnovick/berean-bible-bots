...
Each triplet below shows the **same weak root** in three stems: Qal, Piel, and Pual. For each form:

1. Identify the **stem** (Qal / Piel / Pual).
2. Provide the full **parse** (conjugation, person, gender, number).
3. Give the **translation**.

Focus on the R1 vowel as your primary stem indicator, and watch for the weak-root changes that affect these forms.
...
## Triplet 1 — Root: גלה (III-ה)

| # | Form | Stem | Conjugation | PGN | Translation |
|---|---|---|---|---|---|
| 1 | גָּלָה | | | | |
| 2 | גִּלָּה | | | | |
| 3 | גֻּלָּה | | | | |
...
*Notes: Qal כָּלָה is intransitive (to come to an end). Piel כִּלָּה is transitive/factitive (to bring to completion or destroy). Pual כֻּלָּה: same III-ה Pual pattern as גֻּלָּה.*

### Triplet 3 — Root: ברך (I-Guttural, R2 = ר)
