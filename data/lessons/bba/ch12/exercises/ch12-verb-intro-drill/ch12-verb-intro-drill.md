...
1. **Stem** — identify which of the nine stems (Peal, Peil, Ithpeel, Pael, Ithpaal, Haphel, Hophal, Shaph'el, Ithhaph'al)
2. **Root** — the three-letter root (use the lexical form convention: 3ms Peal perfect)
3. **Gloss** — an English translation of the verb form as it appears in the verse
