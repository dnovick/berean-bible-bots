    ...
    def _build(self) -> None:
        ...
        parts = [
            ...
            ('H', 'נקם', 'Geminate — Qibbuts prefix; Dagesh forte in R2', [
                ...
                ['8',  'נקם', 'Inf. Construct',      '—',        ''],
                ['9',  'נקם', 'Perfect 3fs',         '—',        ''],
                ['10', 'נקם', 'Imperfect 3fs / 2ms', '—',        ''],
                ['11', 'נקם', 'Imperfect 1cs',       '—',        ''],
                ['12', 'נקם', 'Imperfect 1cp',       '—',        ''],
                ['13', 'נקם', 'Perfect 1cs',         '—',        ''],
                ['14', 'נקם', 'Perfect 1cp',         '—',        ''],
                ['15', 'נקם', 'Participle mp',       '—',        ''],
            ], [
                ...
                ['9',  'נקם', 'Perfect 3fs',         '—',        'הֻקְּמָה'],
                ['10', 'נקם', 'Imperfect 3fs / 2ms', '—',        'תֻּקַּם'],
                ['11', 'נקם', 'Imperfect 1cs',       '—',        'אֻקַּם'],
                ['12', 'נקם', 'Imperfect 1cp',       '—',        'נֻקַּם'],
                ['13', 'נקם', 'Perfect 1cs',         '—',        'הֻקַּמְתִּי'],
                ['14', 'נקם', 'Perfect 1cp',         '—',        'הֻקַּמְנוּ'],
                ['15', 'נקם', 'Participle mp',       '—',        'מֻקָּמִים'],
            ]),
        ]
