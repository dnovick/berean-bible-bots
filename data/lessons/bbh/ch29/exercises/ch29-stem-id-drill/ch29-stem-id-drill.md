# Chapter 29 — Stem-ID Drill (Weak Roots)
...
This drill mixes 36 forms of weak roots (hollow and I-י), drawn from the stems you have learned through Chapter 29: **Qal, Niphal, Hiphil, and Hophal**. For each item:

1. **Identify the stem** (Qal / Niphal / Hiphil / Hophal).
2. **Parse** the conjugation and PGN.
3. **Identify the root** (בוא / שׁוב / ירד / קום / ילד).
4. **Translate** the form.

Items are deliberately mixed — not grouped by conjugation — so that the student must apply morphological markers without a structural cue.

> **Note on item 18:** The Niphal Imperfect 3ms of the hollow root בוא is **יִוָּבֵא** — the נ assimilates (dagesh-forte in ו) and the middle root consonant ו is retained.

---

## Exercise Table

| # | Hebrew | Stem | Conjugation | PGN | Root | Translation |
|---|---|---|---|---|---|---|
| 1 | בָּאָה | | | | | |
| 2 | הֵבִיא | | | | | |
| 3 | שַׁבְתִּי | | | | | |
...
| 5 | הֵשִׁיבוּ | **Hiphil** | Perfect | 3mp | שׁוב | they brought back / restored |
| 6 | בָּא | **Qal** | Perfect | 3ms | בוא | he came |
| 7 | שָׁב | **Qal** | Perfect | 3ms | שׁוב | he returned |
| 8 | הֵשִׁיב | **Hiphil** | Perfect | 3ms | שׁוב | he brought back / restored |
...
| 15 | יָבוֹא | **Qal** | Imperfect | 3ms | בוא | he will come / he comes |
