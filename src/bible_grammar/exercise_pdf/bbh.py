...
class Ch1LetterRecognitionExercise(ExercisePDF):
    def _build(self) -> None:
        ...
        self.add_generic_table(
            ...
            rows=rows,
            col_ratios=[0.05, 0.08, 0.22, 0.65],
            heb_cols=[1],
            show_answers=True,
            answer_rows=ans,
        )
...
class Ch3SyllableDivisionExercise(ExercisePDF):
    def _build(self) -> None:
        ...
        ans = [
            ...
            ['3', 'הָאָרֶץ', 'הָ-אָ-רֶץ', 'O-O-C', 'אָ*'],
            ['4', 'שָׁמַיִם', 'שָׁ-מַ-יִם', 'O-O-C', 'יִם*'],
            ['5', 'יְרוּשָׁלַיִם', 'יְ-רוּ-שָׁ-לַ-יִם', 'O-O-O-O-C', 'לַ*'],
            ['6', 'דָּבָר', 'דָּ-בָר', 'O-O', 'בָר*'],
            ['7', 'מֶלֶךְ', 'מֶ-לֶךְ', 'O-C', 'מֶ*'],
            ...
            ['17', 'חֶסֶד', 'חֶ-סֶד', 'O-C', 'חֶ*'],
            ['18', 'קֹדֶשׁ', 'קֹ-דֶשׁ', 'O-C', 'קֹ*'],
            ['19', 'אֶרֶץ', 'אֶ-רֶץ', 'O-C', 'אֶ*'],
            ['20', 'עַם', 'עַם', 'C', 'עַם*'],
        ]
        self.add_generic_table(
...
class Ch3FurtiveQuiescentExercise(ExercisePDF):
    def _build(self) -> None:
        ...
        ans = [
            ...
            ['2', 'דָּבָר', 'word', 'neither'],
            ['3', 'חַטָּאת', 'sin', 'Quiescent א (not counted in syllabification)'],
            ['4', 'רָקִיעַ', 'expanse, firmament', 'Furtive Pathach (final ע)'],
            ['5', 'מֶ֫לֶךְ', 'king', 'neither'],
            ['6', 'רוּחַ', 'spirit, wind', 'Furtive Pathach (final ח; monosyllabic)'],
            ['7', 'רֹאשׁ', 'head', 'Quiescent א (between Holem and Shin)'],
            ['8', 'שָׁלוֹם', 'peace', 'neither'],
            ['9', 'נֹטֵעַ', 'planting', 'Furtive Pathach (final ע)'],
            ['10', 'מָצָא', 'he found', 'neither (final א carries its own vowel, Qamets)'],
        ]
        self.add_generic_table(
...
class Ch28HophalParadigmDrill(ExercisePDF):
    ...
    def _build(self) -> None:
        ...
        # Part A — Perfect — Root שׁלך
        rows_pf = [
            ['1', 'שׁלך', '3ms', ''], ['2', 'שׁלך', '3fs  Ezk 19:12', ''],
            ['3', 'שׁלך', '2ms  Isa 14:19*', ''], ['4', 'שׁלך', '2fs', ''],
            ['5', 'שׁלך', '1cs  Psa 22:10*', ''], ['6', 'שׁלך', '3cp', ''],
            ['7', 'שׁלך', '2mp', ''], ['8', 'שׁלך', '2fp', ''],
            ['9', 'שׁלך', '1cp', ''],
        ]
        ans_pf = [
            ['1', 'שׁלך', '3ms', 'הֻשְׁלַךְ'], ['2', 'שׁלך', '3fs', 'הֻשְׁלְכָה'],
            ['3', 'שׁלך', '2ms', 'הֻשְׁלַכְתָּ'], ['4', 'שׁלך', '2fs', 'הֻשְׁלַכְתְּ'],
            ['5', 'שׁלך', '1cs', 'הֻשְׁלַכְתִּי'], ['6', 'שׁלך', '3cp', 'הֻשְׁלְכוּ'],
            ['7', 'שׁלך', '2mp', 'הֻשְׁלַכְתֶּם'], ['8', 'שׁלך', '2fp', 'הֻשְׁלַכְתֶּן'],
            ['9', 'שׁלך', '1cp', 'הֻשְׁלַכְנוּ'],
        ]

        # Part B — Imperfect — Root שׁלך
        rows_imp = [
            ['1', 'שׁלך', '3ms', ''], ['2', 'שׁלך', '3fs', ''],
            ['3', 'שׁלך', '2ms (=3fs)', ''], ['4', 'שׁלך', '2fs', ''],
            ['5', 'שׁלך', '1cs', ''], ['6', 'שׁלך', '3mp  Isa 34:3', ''],
            ['7', 'שׁלך', '3fp', ''], ['8', 'שׁלך', '2mp', ''],
            ['9', 'שׁלך', '2fp (=3fp)', ''], ['10', 'שׁלך', '1cp', ''],
        ]
        ans_imp = [
            ['1', 'שׁלך', '3ms', 'יֻשְׁלַךְ'], ['2', 'שׁלך', '3fs', 'תֻּשְׁלַךְ'],
            ['3', 'שׁלך', '2ms', 'תֻּשְׁלַךְ'], ['4', 'שׁלך', '2fs', 'תֻּשְׁלְכִי'],
            ['5', 'שׁלך', '1cs', 'אֻשְׁלַךְ'], ['6', 'שׁלך', '3mp', 'יֻשְׁלְכוּ'],
            ['7', 'שׁלך', '3fp', 'תֻּשְׁלַכְנָה'], ['8', 'שׁלך', '2mp', 'תֻּשְׁלְכוּ'],
            ['9', 'שׁלך', '2fp', 'תֻּשְׁלַכְנָה'], ['10', 'שׁלך', '1cp', 'נֻשְׁלַךְ'],
        ]

        # Parts C–F (misc) — all using שׁלך except Inf. Abs. מות
        hdrs_misc = ['#', 'Root', 'Form / PGN', 'Hophal Form']
        rows_misc = [
            ['1', 'שׁלך', 'Inf. Construct (base)', ''],
            ['2', 'שׁלך', 'Inf. Construct +לְ', ''],
            ['3', 'מות', 'Inf. Absolute', ''],
            ['4', 'שׁלך', 'Participle ms  2Sa 20:21', ''],
            ['5', 'שׁלך', 'Participle fs  1Ki 13:24', ''],
            ['6', 'שׁלך', 'Participle mp  Jer 14:16', ''],
            ['7', 'שׁלך', 'Participle fp', ''],
            ['8', 'שׁלך', 'Imperative 2ms', ''],
            ['9', 'שׁלך', 'Imperative 2mp', ''],
        ]
        ans_misc = [
            ['1', 'שׁלך', 'Inf. Construct (base)', 'הֻשְׁלַךְ'],
            ['2', 'שׁלך', 'Inf. Construct +לְ', 'לְהֻשְׁלַךְ'],
            ['3', 'מות', 'Inf. Absolute', 'הוּמֵת'],
            ['4', 'שׁלך', 'Participle ms', 'מֻשְׁלָךְ'],
            ['5', 'שׁלך', 'Participle fs', 'מֻשְׁלֶכֶת'],
            ['6', 'שׁלך', 'Participle mp', 'מֻשְׁלָכִים'],
            ['7', 'שׁלך', 'Participle fp', 'מֻשְׁלָכוֹת'],
            ['8', 'שׁלך', 'Imperative 2ms', 'הֻשְׁלַךְ'],
            ['9', 'שׁלך', 'Imperative 2mp', 'הֻשְׁלְכוּ'],
        ]

        self.add_drill_with_answer_key(hdrs, rows_pf, ans_pf, col_ratios=cr,
                                       answer_heb_cols=[1, 3],
                                       section_title='Part A — Hophal Perfect (Root שׁלך)',
                                       answer_title='Part A — Answer Key')
        self.add_drill_with_answer_key(hdrs, rows_imp, ans_imp, col_ratios=cr,
                                       answer_heb_cols=[1, 3],
                                       section_title='Part B — Hophal Imperfect (Root שׁלך)',
                                       answer_title='Part B — Answer Key')
        self.add_drill_with_answer_key(hdrs_misc, rows_misc, ans_misc, col_ratios=cr,
                                       answer_heb_cols=[1, 3],
    ...
    def _build(self) -> None:
        ...
        parts = [
            ('A', 'ילד', 'I-י/ו — Shureq prefix', [
                ...
                ['8',  'ילד', 'Inf. Construct',      '—',        ''],
                ['9',  'ילד', 'Perfect 3fs',         '—',        ''],
                ['10', 'ילד', 'Imperfect 3fs / 2ms', '—',        ''],
                ['11', 'ילד', 'Imperfect 1cs',       '—',        ''],
                ['12', 'ילד', 'Imperfect 1cp',       '—',        ''],
                ['13', 'ילד', 'Perfect 1cs',         '—',        ''],
                ['14', 'ילד', 'Perfect 1cp',         '—',        ''],
                ['15', 'ילד', 'Participle mp',       '—',        ''],
            ], [
                ...
                ['9',  'ילד', 'Perfect 3fs',         '—',        'הוּלְדָה'],
                ['10', 'ילד', 'Imperfect 3fs / 2ms', '—',        'תּוּלַד'],
                ['11', 'ילד', 'Imperfect 1cs',       '—',        'אוּלַד'],
                ['12', 'ילד', 'Imperfect 1cp',       '—',        'נוּלַד'],
                ['13', 'ילד', 'Perfect 1cs',         '—',        'הוּלַדְתִּי'],
                ['14', 'ילד', 'Perfect 1cp',         '—',        'הוּלַדְנוּ'],
                ['15', 'ילד', 'Participle mp',       '—',        'מוּלָדִים'],
            ]),
            ('B', 'קום', 'Biconsonantal — Shureq prefix', [
                ...
                ['8',  'קום', 'Inf. Construct',      '—',         ''],
                ['9',  'קום', 'Perfect 3fs',         '—',         ''],
                ['10', 'קום', 'Imperfect 3fs / 2ms', '—',         ''],
                ['11', 'קום', 'Imperfect 1cs',       '—',         ''],
                ['12', 'קום', 'Imperfect 1cp',       '—',         ''],
                ['13', 'קום', 'Perfect 1cs',         '—',         ''],
                ['14', 'קום', 'Perfect 1cp',         '—',         ''],
                ['15', 'קום', 'Participle mp',       '—',         ''],
            ], [
                ...
                ['9',  'קום', 'Perfect 3fs',         '—',         'הוּקְמָה'],
                ['10', 'קום', 'Imperfect 3fs / 2ms', '—',         'תּוּקַם'],
                ['11', 'קום', 'Imperfect 1cs',       '—',         'אוּקַם'],
                ['12', 'קום', 'Imperfect 1cp',       '—',         'נוּקַם'],
                ['13', 'קום', 'Perfect 1cs',         '—',         'הוּקַמְתִּי'],
                ['14', 'קום', 'Perfect 1cp',         '—',         'הוּקַמְנוּ'],
                ['15', 'קום', 'Participle mp',       '—',         'מוּקָמִים'],
            ]),
            ('C', 'עמד', 'I-guttural — Seghol Perfect 3ms only; Qibbuts all other forms', [
                ['1',  'עמד', 'Perfect 3ms',         '—', ''],
                ['2',  'עמד', 'Imperfect 3ms',       '—', ''],
                ['3',  'עמד', 'Participle ms',       '—', ''],
                ['4',  'עמד', 'Perfect 3cp',         '—', ''],
                ...
                ['8',  'עמד', 'Inf. Construct',      '—', ''],
                ['9',  'עמד', 'Perfect 3fs',         '—', ''],
                ['10', 'עמד', 'Imperfect 3fs / 2ms', '—', ''],
                ['11', 'עמד', 'Imperfect 1cs',       '—', ''],
                ['12', 'עמד', 'Imperfect 1cp',       '—', ''],
                ['13', 'עמד', 'Perfect 1cs',         '—', ''],
                ['14', 'עמד', 'Perfect 1cp',         '—', ''],
                ['15', 'עמד', 'Participle mp',       '—', ''],
            ], [
                ...
                ['9',  'עמד', 'Perfect 3fs',         '—', 'הֻעֲמְדָה'],
                ['10', 'עמד', 'Imperfect 3fs / 2ms', '—', 'תֻּעֲמַד'],
                ['11', 'עמד', 'Imperfect 1cs',       '—', 'אֻעֲמַד'],
                ['12', 'עמד', 'Imperfect 1cp',       '—', 'נֻעֲמַד'],
                ['13', 'עמד', 'Perfect 1cs',         '—', 'הֻעֲמַדְתִּי'],
                ['14', 'עמד', 'Perfect 1cp',         '—', 'הֻעֲמַדְנוּ'],
                ['15', 'עמד', 'Participle mp',       '—', 'מֻעֲמָדִים'],
            ]),
            ('D', 'נגד', 'I-נ — Qibbuts prefix; Dagesh forte in R2', [
                ...
                ['8',  'נגד', 'Inf. Construct',      '—',        ''],
                ['9',  'נגד', 'Perfect 3fs',         '—',        ''],
                ['10', 'נגד', 'Imperfect 3fs / 2ms', '—',        ''],
                ['11', 'נגד', 'Imperfect 1cs',       '—',        ''],
                ['12', 'נגד', 'Imperfect 1cp',       '—',        ''],
                ['13', 'נגד', 'Perfect 1cs',         '—',        ''],
                ['14', 'נגד', 'Perfect 1cp',         '—',        ''],
                ['15', 'נגד', 'Participle mp',       '—',        ''],
            ], [
                ...
                ['9',  'נגד', 'Perfect 3fs',         '—',        'הֻגְּדָה'],
                ['10', 'נגד', 'Imperfect 3fs / 2ms', '—',        'תֻּגַּד'],
                ['11', 'נגד', 'Imperfect 1cs',       '—',        'אֻגַּד'],
                ['12', 'נגד', 'Imperfect 1cp',       '—',        'נֻגַּד'],
                ['13', 'נגד', 'Perfect 1cs',         '—',        'הֻגַּדְתִּי'],
                ['14', 'נגד', 'Perfect 1cp',         '—',        'הֻגַּדְנוּ'],
                ['15', 'נגד', 'Participle mp',       '—',        'מֻגָּדִים'],
            ]),
            ('E', 'גלה', 'III-ה — Qibbuts; contracted endings; apocopated Wayyiqtol', [
                ...
                ['8',  'גלה', 'Inf. Construct',      '—',           ''],
                ['9',  'גלה', 'Perfect 3fs',         '—',           ''],
                ['10', 'גלה', 'Imperfect 3fs / 2ms', '—',           ''],
                ['11', 'גלה', 'Imperfect 1cs',       '—',           ''],
                ['12', 'גלה', 'Imperfect 1cp',       '—',           ''],
                ['13', 'גלה', 'Perfect 1cs',         '—',           ''],
                ['14', 'גלה', 'Perfect 1cp',         '—',           ''],
                ['15', 'גלה', 'Participle mp',       '—',           ''],
            ], [
                ...
                ['9',  'גלה', 'Perfect 3fs',         '—',           'הֻגְלְתָה'],
                ['10', 'גלה', 'Imperfect 3fs / 2ms', '—',           'תֻּגְלֶה'],
                ['11', 'גלה', 'Imperfect 1cs',       '—',           'אֻגְלֶה'],
                ['12', 'גלה', 'Imperfect 1cp',       '—',           'נֻגְלֶה'],
                ['13', 'גלה', 'Perfect 1cs',         '—',           'הֻגְלֵיתִי'],
                ['14', 'גלה', 'Perfect 1cp',         '—',           'הֻגְלֵינוּ'],
                ['15', 'גלה', 'Participle mp',       '—',           'מֻגְלִים'],
            ]),
            ('F', 'שׁלח', 'III-ח/ע — Qibbuts prefix; Patach furtive before final guttural', [
                ...
                ['9',  'שׁלח', 'Perfect 3fs',         '—',         ''],
                ['10', 'שׁלח', 'Imperfect 3fs / 2ms', '—',         ''],
                ['11', 'שׁלח', 'Imperfect 1cs',       '—',         ''],
                ['12', 'שׁלח', 'Imperfect 1cp',       '—',         ''],
                ['13', 'שׁלח', 'Perfect 1cs',         '—',         ''],
                ['14', 'שׁלח', 'Perfect 1cp',         '—',         ''],
                ['15', 'שׁלח', 'Participle mp',       '—',         ''],
            ], [
                ...
                ['9',  'שׁלח', 'Perfect 3fs',         '—',         'הֻשְׁלְחָה'],
                ['10', 'שׁלח', 'Imperfect 3fs / 2ms', '—',         'תֻּשְׁלַח'],
                ['11', 'שׁלח', 'Imperfect 1cs',       '—',         'אֻשְׁלַח'],
                ['12', 'שׁלח', 'Imperfect 1cp',       '—',         'נֻשְׁלַח'],
                ['13', 'שׁלח', 'Perfect 1cs',         '—',         'הֻשְׁלַחְתִּי'],
                ['14', 'שׁלח', 'Perfect 1cp',         '—',         'הֻשְׁלַחְנוּ'],
                ['15', 'שׁלח', 'Participle mp',       '—',         'מֻשְׁלָחִים'],
            ]),
            ('G', 'מצא', 'III-א — Qibbuts prefix; Qamets before silent final א', [
                ...
                ['8',  'מצא', 'Inf. Construct',      '—', ''],
                ['9',  'מצא', 'Perfect 3fs',         '—', ''],
                ['10', 'מצא', 'Imperfect 3fs / 2ms', '—', ''],
                ['11', 'מצא', 'Imperfect 1cs',       '—', ''],
                ['12', 'מצא', 'Imperfect 1cp',       '—', ''],
                ['13', 'מצא', 'Perfect 1cs',         '—', ''],
                ['14', 'מצא', 'Perfect 1cp',         '—', ''],
                ['15', 'מצא', 'Participle mp',       '—', ''],
            ], [
                ...
                ['9',  'מצא', 'Perfect 3fs',         '—', 'הֻמְצְאָה'],
                ['10', 'מצא', 'Imperfect 3fs / 2ms', '—', 'תֻּמְצָא'],
                ['11', 'מצא', 'Imperfect 1cs',       '—', 'אֻמְצָא'],
                ['12', 'מצא', 'Imperfect 1cp',       '—', 'נֻמְצָא'],
                ['13', 'מצא', 'Perfect 1cs',         '—', 'הֻמְצֵאתִי'],
                ['14', 'מצא', 'Perfect 1cp',         '—', 'הֻמְצֵאנוּ'],
                ['15', 'מצא', 'Participle mp',       '—', 'מֻמְצָאִים'],
            ]),
            ('H', 'קלל', 'Geminate — Qibbuts prefix; Dagesh forte in R2 (= R3)', [
                ['1',  'קלל', 'Perfect 3ms',         '—', ''],
                ['2',  'קלל', 'Imperfect 3ms',       '—', ''],
                ['3',  'קלל', 'Participle ms',       '—', ''],
                ['4',  'קלל', 'Perfect 3cp',         '—', ''],
                ...
                ['8',  'קלל', 'Inf. Construct',      '—', ''],
                ['9',  'קלל', 'Perfect 3fs',         '—', ''],
                ['10', 'קלל', 'Imperfect 3fs / 2ms', '—', ''],
                ['11', 'קלל', 'Imperfect 1cs',       '—', ''],
                ['12', 'קלל', 'Imperfect 1cp',       '—', ''],
                ['13', 'קלל', 'Perfect 1cs',         '—', ''],
                ['14', 'קלל', 'Perfect 1cp',         '—', ''],
                ['15', 'קלל', 'Participle mp',       '—', ''],
            ], [
                ['1',  'קלל', 'Perfect 3ms',         '—', 'הֻקַּל'],
                ['2',  'קלל', 'Imperfect 3ms',       '—', 'יֻקַּל'],
                ['3',  'קלל', 'Participle ms',       '—', 'מֻקָּל'],
                ['4',  'קלל', 'Perfect 3cp',         '—', 'הֻקְּלוּ'],
                ['5',  'קלל', 'Imperfect 3mp',       '—', 'יֻקְּלוּ'],
                ['6',  'קלל', 'Participle fs',       '—', 'מֻקֶּלֶת'],
                ['7',  'קלל', 'Imperative ms',       '—', 'הֻקַּל'],
                ['8',  'קלל', 'Inf. Construct',      '—', 'הֻקַּל'],
                ['9',  'קלל', 'Perfect 3fs',         '—', 'הֻקְּלָה'],
                ['10', 'קלל', 'Imperfect 3fs / 2ms', '—', 'תֻּקַּל'],
                ['11', 'קלל', 'Imperfect 1cs',       '—', 'אֻקַּל'],
                ['12', 'קלל', 'Imperfect 1cp',       '—', 'נֻקַּל'],
                ['13', 'קלל', 'Perfect 1cs',         '—', 'הֻקַּלְתִּי'],
                ['14', 'קלל', 'Perfect 1cp',         '—', 'הֻקַּלְנוּ'],
                ['15', 'קלל', 'Participle mp',       '—', 'מֻקָּלִים'],
            ]),
        ]
...
class Ch29HiphilPassiveDrillExercise(ExercisePDF):
    ...
    def _build(self) -> None:
        ...
        rows = [
            ...
            ['25', 'יֻקַּם',     'נקם',  'I-נ',           'Imperfect 3ms',  '', ''],
        ]
        ans = [
            ...
            ['25', 'יֻקַּם',     'נקם',  'I-נ',           'Imperfect 3ms',  'Qal נָקַם: to avenge',                            'he shall be avenged (Gen 4:15)'],
        ]
        self.add_drill_with_answer_key(
            hdr, rows, ans,
            col_ratios=cr,
...
class Ch2ProperNamesExercise(ExercisePDF):
    def _build(self) -> None:
        self.add_instructions(
            'For each Hebrew proper name, write the English name and indicate whether '
            'any vowel letters (matres lectionis — waw, yod, or he functioning as '
            'vowel holders) are present.'
        )
        rows = [
            ['1',  'שָׂרָה', '', ''],
            ['2',  'נֹחַ', '', ''],
        ...
        ans = [
            ['1',  'שָׂרָה', 'Sarah', 'Yes — he (Qamets He)'],
            ['2',  'נֹחַ', 'Noah', 'No'],
            ['3',  'דָּוִד', 'David', 'No (waw is a consonant)'],
            ['4',  'רוּת', 'Ruth', 'Yes — waw (Shureq)'],
            ['5',  'לֵאָה', 'Leah', 'Yes — he (Qamets He)'],
            ['6',  'מֹשֶׁה', 'Moses', 'Yes — he (Seghol He)'],
            ['7',  'יַעֲקֹב', 'Jacob', 'No'],
            ['8',  'יִצְחָק', 'Isaac', 'No'],
            ['9',  'אַהֲרֹן', 'Aaron', 'No'],
            ['10', 'מִרְיָם', 'Miriam', 'No (yod is a consonant)'],
            ['11', 'שְׁלֹמֹה', 'Solomon', 'Yes — he (Holem He)'],
            ['12', 'אֱלִיָּהוּ', 'Elijah', 'Yes — waw (Shureq)'],
            ['13', 'יוֹסֵף', 'Joseph', 'Yes — waw (Holem Waw)'],
            ['14', 'אַבְרָהָם', 'Abraham', 'No'],
            ['15', 'יְרוּשָׁלַיִם', 'Jerusalem', 'Yes — waw (Shureq)'],
        ]
        self.add_generic_table(
            headers=['#', 'Hebrew Name', 'English Name', 'Matres Lectionis?'],
            rows=rows,
            col_ratios=[0.05, 0.18, 0.32, 0.45],
            heb_cols=[1],
            show_answers=True,
            answer_rows=ans,
        )
...
# ---------------------------------------------------------------------------
# Ch2 — Consonant-Vowel Reading Drill
# ---------------------------------------------------------------------------

_READING_DRILL_ROWS = [
    ('1',  'Bet (בּ)',    'בּוּ בָּ בִּי בַּ בּוֹ בֵּ בֶּ בֹּ בֻּ בֵּי'),
    ('2',  'Mem (מ)',     'מָה מִ מֹ מֶה מֵ מֵה מַ מֹה מֻ מָ'),
    ('3',  'Shin (שׁ)',   'שִׁי שֵׁ שָׁ שׁוּ שַׁ שֹׁ שֵׁי שׁוֹ שֶׁ שִׁ'),
    ('4',  'Lamed (ל)',   'לֵ לוֹ לַ לָה לִ לֶ לָ לֵי לֹ לֻ'),
    ('5',  'Nun (נ)',     'נָ נֶה נִי נֵ נֹ נֶ נוּ נַ נֹה נְ'),
    ('6',  'Dalet (דּ)',  'דֵּי דָּ דּוּ דִּ דֵּ דּוֹ דַּ דִּי דֹּ דֶּ'),
    ('7*', 'Alef (א)',    'אֵ אֲ אָ אֶ אֳ אִ אַ אֱ אֹ אוּ'),
    ('8',  'Kaf (כּ)',    'כּוֹ כַּ כֵּי כִּ כָּה כֶּ כָּ כֵּ כֵּה כֻּ'),
    ('9*', 'He (ה)',      'הֶ הֳ הָ הֲ הֵ הֹ הֱ הַ הִ הוּ'),
    ('10', 'Pe (פּ)',     'פֵּי פָּ פּוּ פֹּ פֶּה פִּ פֵּ פִּי פַּ פֹּה'),
    ('11', 'Taw (תּ)',    'תּוֹ תָּ תִּי תַּ תֵּ תֶּ תּוּ תֵּי תֹּ תִּ'),
    ('12', 'Resh (ר)',    'רָ רֵה רִי רֶ רֹ רוּ רַ רֵ רָה רִ'),
    ('13', 'Gimel (גּ)', 'גּוֹ גָּ גֶּה גַּ גֵּ גּוּ גִּי גֹּ גֵּי גֶּ'),
    ('14*', 'Ayin (ע)',   'עֶ עֲ עָ עֱ עַ עֳ עִ עֵ עֹ עוּ'),
    ('15', 'Tsade (צ)',   'צֵי צָה צִ צוֹ צֶ צָ צַ צֹה צוּ צֵ'),
]

_READING_DRILL_KEY = [
    ('1',  'Bet (בּ)',    'Shureq · Qamets · Hireq Yod · Pathach · Holem Waw · Tsere · Seghol · Holem · Qibbuts · Tsere Yod'),
    ('2',  'Mem (מ)',     'Qamets He · Hireq · Holem · Seghol He · Tsere · Tsere He · Pathach · Holem He · Qibbuts · Qamets'),
    ('3',  'Shin (שׁ)',   'Hireq Yod · Tsere · Qamets · Shureq · Pathach · Holem · Tsere Yod · Holem Waw · Seghol · Hireq'),
    ('4',  'Lamed (ל)',   'Tsere · Holem Waw · Pathach · Qamets He · Hireq · Seghol · Qamets · Tsere Yod · Holem · Qibbuts'),
    ('5',  'Nun (נ)',     'Qamets · Seghol He · Hireq Yod · Tsere · Holem · Seghol · Shureq · Pathach · Holem He · Vocal Shewa'),
    ('6',  'Dalet (דּ)',  'Tsere Yod · Qamets · Shureq · Hireq · Tsere · Holem Waw · Pathach · Hireq Yod · Holem · Seghol'),
    ('7*', 'Alef (א)',    'Tsere · Hateph Pathach · Qamets · Seghol · Hateph Qamets · Hireq · Pathach · Hateph Seghol · Holem · Shureq'),
    ('8',  'Kaf (כּ)',    'Holem Waw · Pathach · Tsere Yod · Hireq · Qamets He · Seghol · Qamets · Tsere · Tsere He · Qibbuts'),
    ('9*', 'He (ה)',      'Seghol · Hateph Qamets · Qamets · Hateph Pathach · Tsere · Holem · Hateph Seghol · Pathach · Hireq · Shureq'),
    ('10', 'Pe (פּ)',     'Tsere Yod · Qamets · Shureq · Holem · Seghol He · Hireq · Tsere · Hireq Yod · Pathach · Holem He'),
    ('11', 'Taw (תּ)',    'Holem Waw · Qamets · Hireq Yod · Pathach · Tsere · Seghol · Shureq · Tsere Yod · Holem · Hireq'),
    ('12', 'Resh (ר)',    'Qamets · Tsere He · Hireq Yod · Seghol · Holem · Shureq · Pathach · Tsere · Qamets He · Hireq'),
    ('13', 'Gimel (גּ)', 'Holem Waw · Qamets · Seghol He · Pathach · Tsere · Shureq · Hireq Yod · Holem · Tsere Yod · Seghol'),
    ('14*', 'Ayin (ע)',   'Seghol · Hateph Pathach · Qamets · Hateph Seghol · Pathach · Hateph Qamets · Hireq · Tsere · Holem · Shureq'),
    ('15', 'Tsade (צ)',   'Tsere Yod · Qamets He · Hireq · Holem Waw · Seghol · Qamets · Pathach · Holem He · Shureq · Tsere'),
]


class Ch2ReadingDrillExercise(ExercisePDF):
    def _build(self) -> None:
        self.add_instructions(
            'Read each line aloud, pronouncing each consonant-vowel syllable in sequence. '
            'Your instructor will call on individual students to read a line. '
            'Rows marked with * use guttural consonants and include Hateph (composite) shewas.'
        )
        self.add_generic_table(
            headers=['#', 'Consonant', 'Reading Line'],
            rows=[[r[0], r[1], r[2]] for r in _READING_DRILL_ROWS],
            col_ratios=[0.06, 0.22, 0.72],
            heb_cols=[2],
            show_answers=False,
            answer_rows=None,
        )
        self.add_section_heading('Vowel Key')
        self.add_generic_table(
            headers=['#', 'Consonant', 'Vowel Names (syllables 1–10, in order)'],
            rows=[[r[0], r[1], r[2]] for r in _READING_DRILL_KEY],
            col_ratios=[0.06, 0.22, 0.72],
            heb_cols=[],
            show_answers=False,
            answer_rows=None,
...
def build_ch2_reading_drill(out_dir: Optional[str] = None) -> str:
    return _build_exercise_pdf(
        Ch2ReadingDrillExercise,
        'Chapter 2 — Consonant-Vowel Reading Drill',
        'Hebrew Vowels — Sight Reading Practice (15 rows × 10 syllables)',
        ['bbh', 'ch2', 'exercises', 'ch2-reading-drill'],
        'ch2-reading-drill.pdf',
        out_dir,
    )
