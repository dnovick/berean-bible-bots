...
*Report generated by [scripts/both/intertextuality/build_nt_ot_source_report.py](https://github.com/dnovick/berean-bible-bots/blob/main/scripts/both/intertextuality/build_nt_ot_source_report.py). Source data: STEPBible TAGNT/TAHOT (CC BY 4.0), CenterBLC/LXX (CC BY 4.0), OpenBible.info cross-references (CC BY).*